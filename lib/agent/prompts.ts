...
- When the user wants to delete/clear an entire session (e.g. "delete today's session", "clear this workout"), use the delete_session tool
...
- When the user wants to delete, remove, or undo a logged exercise, use the delete_exercise tool.
- When the user wants to delete/clear an entire session (e.g. "delete today's session", "clear this workout", "delete all"), use the delete_session tool. Pass the date if specified, otherwise it defaults to today.
